				...
				<div class="container">
					<div class="row">
						<div class="col-12 text-center">
							<?php
							if ( is_singular() ) :
								the_title( '<h1 class="entry-title titulo-single-product">', '</h1>' );
							else :
								the_title( '<h2 class="entry-title titulo-single-product"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h2>' );
							endif;
